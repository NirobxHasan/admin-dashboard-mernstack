...
import { Drawer, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Typography, useTheme } from '@mui/material';
    ...
    <Box>
        {isSidebarOpen && (
            <Drawer
                ...
                sx={{
                    width: drawerWidth,
                    "& .MuiDrawer-paper":{  //Modify  this class
